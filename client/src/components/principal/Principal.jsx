...
class Principal extends React.Component {
  ...
  render() {
    const { usdF, price, monthly, priceStr, interest, interestRate, down, downStr, handleChange } = this.props;
    return (
      <div>
        <div><PandI usdF={usdF} price={price} monthly={monthly} /></div>
        <div><HomePrice usdF={usdF} price={price} priceStr={priceStr} handleChange={handleChange} /></div>
